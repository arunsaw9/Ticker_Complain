	            ...
	            <div class="col-lg-3 col-md-6 col-12">
	              <div class="card">
	                  <div class="card-header d-flex flex-column align-items-start pb-0">
	                      ...
	                      <p class="mb-0">PAR Completion: <span style="color: red">{{ $MoU[0]['PAR_Completion']}}%</span></p>
	                      <p class="mb-0">Training in CoE: <span style="color: red">{{ $MoU[0]['Training_in_CoE']}}%</span></p>
	                      <br>
                ...
                <div class="col-lg-3 col-md-6 col-12">
                  <div class="card">
                    <div class="card-header d-flex flex-column align-items-start pb-0">
                        ...
                        <br>
                        <span><strong>Tenure Based</strong>          &nbsp;{{$Secondary_Workforce[0]['Tenure_Based']}}</span>
	                    <span><strong>Term Based</strong> 	        &nbsp;{{$Secondary_Workforce[0]['Term_Based']}}</span>
	                    <span><strong>Contract Workers</strong>      &nbsp;{{$Secondary_Workforce[0]['Contract_Workers']}}</span>
	                    <span><strong>Casual/Contingent</strong>     &nbsp;{{$Secondary_Workforce[0]['Casual_Contingent']}}</span>
	                    <br>
                    </div>
